   ...
   //      	$id_user = $this->session->userdata('id');
    ...
    function form()
    {
    	if ($this->lib->login() != "")
		{
			...
			$detail_cart = $this->M_cart->get_where_custom('id_cart', $uri_cart);
   			foreach ($detail_cart->result() as $row_cart) {
   				$id_products = $row_cart->id_products;
   			}
   			$detail_products = $this->M_products->get_where_custom('id_products', $id_products);
